...
namespace DFISYS.Pages
{
    public partial class MediaMng : System.Web.UI.Page
    {
        ...
        public void BinData2(int Id)
        {
            if (Id > 0)
            {
                MediaObject objMediaObject = new MediaObject();
                var Data = objMediaObject.MediaObject_getbyGallleryId(Id);
                if (Data != null && Data.Count > 0)
                {
                   // lbl.Text = "Tên Gallery:" + Data.FirstOrDefault().News_Title;
                }
                GridView1.DataSource = Data;
                GridView1.DataBind();
            ...
            if (val.Length > 0)
            {
                ...
                if (data.Count > 0)
                {
                    ...
                    data.ForEach(p =>
                    {
                        ...
                        strReturn += objMediaObject.MediaObject_Add(Object_Type, p.Object_Url, p.Object_Note, STT, string.Empty, News_ID, GalleryId);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            if (Object_ID > 0)
            {
                ...
                if(GalleryId>0) BinData2(GalleryId);
                else
                BinData(News_ID);
            }
        }
